...
#roads_low::outline[zoom>=5][zoom<=8] {
  [type='motorway'],[type='trunk'] { line-color: #edb919; line-width: 3.0;}
}
...
#roads_low[zoom>=5][zoom<=8] {
  ...
  [zoom=6] {
    [type='motorway'],[type='trunk'] { line-width: 1.7; } }
  [zoom=7] {
    [type='motorway'],[type='trunk'] { line-width: 1.9; } }
  [zoom=8] {
...
#roads_med::outline[zoom>=9][zoom<=10] {
  [zoom=9] {
    [type='motorway'],[type='trunk'] { line-color: #edb919; line-width: 3.8; }
  }
  [zoom=10] {
    [type='motorway'],[type='trunk'] { line-color: #edb919; line-width: 4.0; }
  }
}
